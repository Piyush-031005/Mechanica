    ...
    <>
      ...
      <div style={{
        ...
        <svg width="100%" height="100%" style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
          ...
          {/* Ethereal Sun */}
          <circle cx="50%" cy="50%" r="35%" fill="rgba(255, 0, 60, 0.05)" />
          
          {/* Technical Rings */}
          <circle cx="50%" cy="50%" r="35%" fill="none" stroke="rgba(0, 200, 255, 0.4)" strokeWidth="1" strokeDasharray="4 16" />
          <circle cx="50%" cy="50%" r="40%" fill="none" stroke="rgba(0, 150, 255, 0.3)" strokeWidth="0.5" />
          
          {/* Japanese Watermark typography fading into grid - enhanced visibility */}
          <text x="50%" y="50%" fontSize="20vw" fill="rgba(0, 150, 255, 0.05)" textAnchor="middle" dominantBaseline="central" fontWeight="900" className="text-jp" style={{ writingMode: 'vertical-rl' }}>
            生態系
          </text>
        </svg>
